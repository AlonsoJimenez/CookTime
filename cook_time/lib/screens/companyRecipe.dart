...
class CompanyRecipe extends StatefulWidget {
  @override
  State<CompanyRecipe> createState() => CompanyRecipeState();
}

class CompanyRecipeState extends State<CompanyRecipe> {
  String base64;
  bool private = false;
          ...
          children: [
            ...
            RaisedButton(
              ...
              onPressed: () {
                ...
                tags.add(baseTextFieldControllers[6].text);
                EnterpriseRecipe toSend = EnterpriseRecipe(
                    isPublic: private,
                    ...
                    preparationMinutes:
                        int.parse(baseTextFieldControllers[3].text),
                    difficulty: int.parse(baseTextFieldControllers[5].text),
                    steps: toStringList(stepsTextFieldControllers),
                    ingridients: toStringList(ingredientTextFieldControllers),
                    portionsSize: int.parse(baseTextFieldControllers[2].text),
                    price: int.parse(baseTextFieldControllers[7].text));
                companyRecipe(userForEveryone, passwordForEveryone,
                        companySearch, toSend)
                    .then((response) => {
